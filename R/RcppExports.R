...
#' @export
test_make_calculate_nat_cpp <- function(variables, parameters, index, day) {
    .Call('_safir_test_make_calculate_nat_cpp', PACKAGE = 'safir', variables, parameters, index, day)
}
