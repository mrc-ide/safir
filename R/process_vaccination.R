...
#' #' @export
#' vaccination_process_new <- function(parameters, variables, events, dt) {
#'
...
#'         targets <- target_pop_new(
#'           dose = phase, variables = variables, parameters = parameters, t = timestep, dt = dt, events = events,
...
#'           events = events,dose = phase,parameters = parameters,discrete_age = variables$discrete_age
#'         )
#'
#'         # intermediate phases: give prioritized doses to next group for next phase
#'         if (phase < parameters$N_phase & doses_left > 0) {
#'
#'           targets_pri <- target_pop_new(
#'             dose = phase + 1, variables = variables, parameters = parameters, t = timestep, dt = dt,events = events,
...
#'             events = events,dose = phase + 1,parameters = parameters,discrete_age = variables$discrete_age
#'           )
#'
#'         }
#'
