...
call_nimue_pars <- function(
  ...
  time_period,
  # probabilities
  prob_hosp = nimue_probs$prob_hosp,
  prob_severe = nimue_probs$prob_severe,
  prob_non_severe_death_treatment = nimue_probs$prob_non_severe_death_treatment,
  prob_non_severe_death_no_treatment = nimue_probs$prob_non_severe_death_no_treatment,
  prob_severe_death_treatment = nimue_probs$prob_severe_death_treatment,
  prob_severe_death_no_treatment = nimue_probs$prob_severe_death_no_treatment,
  p_dist = nimue_probs$p_dist,
  # onward infectiousness
  rel_infectiousness = nimue_probs$rel_infectiousness,
  rel_infectiousness_vaccinated = nimue_probs$rel_infectiousness_vaccinated,
  # durations
  dur_E  = nimue_durs$dur_E,
  dur_IMild = nimue_durs$dur_IMild,
  dur_ICase = nimue_durs$dur_ICase,
  # hospital durations
  dur_get_ox_survive = nimue_durs$dur_get_ox_survive,
  dur_get_ox_die = nimue_durs$dur_get_ox_die,
  dur_not_get_ox_survive = nimue_durs$dur_not_get_ox_survive,
  dur_not_get_ox_die = nimue_durs$dur_not_get_ox_die,
  dur_get_mv_survive = nimue_durs$dur_get_mv_survive,
  dur_get_mv_die = nimue_durs$dur_get_mv_die,
  ...
  dur_V = nimue_vaccine_pars$dur_V,
  vaccine_efficacy_infection = nimue_vaccine_pars$vaccine_efficacy_infection,
  tt_vaccine_efficacy_infection = nimue_vaccine_pars$tt_vaccine_efficacy_infection,
  vaccine_efficacy_disease = nimue_vaccine_pars$vaccine_efficacy_disease,
  tt_vaccine_efficacy_disease = nimue_vaccine_pars$tt_vaccine_efficacy_disease,
  max_vaccine = nimue_vaccine_pars$max_vaccine,
  tt_vaccine = nimue_vaccine_pars$tt_vaccine,
  dur_vaccine_delay = nimue_vaccine_pars$dur_vaccine_delay,
  vaccine_coverage_mat = nimue_vaccine_pars$vaccine_coverage_mat,
