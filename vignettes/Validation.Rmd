...
saf_reps <- safir::run_simulation_replicate(
  repetitions = reps, 
  overrides = rep_list(list("pop" = pop, "parameters" = parameters), reps)
  )
...
saf_reps_uk <- safir::run_simulation_replicate(
  repetitions = reps, 
  overrides = rep_list(list("pop" = uk_pop, "parameters" = uk_parameters), reps)
  )
...
ggplot2::ggplot(saf, ggplot2::aes(t, y*div, color = model, group = repetition)) +
  ggplot2::geom_line() +
  ggplot2::facet_wrap(~compartment, scales = "free")
