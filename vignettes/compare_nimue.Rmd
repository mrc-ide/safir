...
Because the variables list used for the simulation contains some bitset objects
which are not variables, the function `simulation_loop_nimue` is used to run
the simulation to handle variable updating correctly. It can be found in r/simulation_loop_nimue.R.
