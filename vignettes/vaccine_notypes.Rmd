...
Plot. This lets us check if people are getting vaccinated; it's the efficacy against infection, averaged over the population, relative to the time of the first dose. It won't look like the cohort plots because everybody gets their second dose at slightly different times, depending on availability.
